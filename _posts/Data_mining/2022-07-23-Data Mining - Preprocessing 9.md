...
<b>1.</b> attribute가 하나도 없는 <a>null model</a> 생성 : $μ_0$<br>  
<b>2.</b> k = 1, 2,..., 10 에 대해서 각 k에 대해서 $_{10}C_k$의 모델을 생성함<br>  
<b>3.</b> k에 대해서 $_{10}C_k$ 개의 모델에서 제일 좋은 성능을 보이는 모델 $μ_k$을 하나씩 선정<br>  
<b>4.</b> 3에서 만들어진 $μ_1, μ_2,...,μ_{10}$ 중에서 단 하나의 Best Model을 선택함<br>  
